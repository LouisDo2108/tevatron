...
python src/tevatron/retriever/driver/train.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/ChroniclingAmericaQA/processed/train.jsonl \
...
python src/tevatron/retriever/driver/encode.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/ChroniclingAmericaQA/processed/corpus.jsonl \
...
python src/tevatron/retriever/driver/encode.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/ChroniclingAmericaQA/processed/test.jsonl \
  --model_name_or_path $OUTPUT_DIR \
  --lora_name_or_path $OUTPUT_DIR \
