...
#SBATCH --nodelist=m3u000,m3u001,m3u002,m3u003,m3u004,m3u005,m3u006,m3u007,m3u008,m3u009
#SBATCH --gres=gpu:A100:1
#SBATCH --qos=fitq
...
#     --model nomic \
#     --data temporal_nobel_prize \
#     --exp_name dev_matryoshka_baseline_filtered \
#     --matryoshka_dim 768 \
#     --matryoshka_dim_list 64 128 256 512 768 \
#     --batch_size 256 \
#     --eval_batch_size 256 \
