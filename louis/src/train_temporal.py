...
from models import TemporalProjectorReconstruction
...
def main():
    ...
    # model = TemporalProjectorReconstruction.load(
    #     model_args.model_name_or_path,
    #     pooling=model_args.pooling,
    #     normalize=model_args.normalize,
    #     lora_name_or_path="/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/temporal_nobel_prize/temporal/thenlper/gte-base/matryoshka_64-128-256-512-768_filtered_avg", # model_args.lora_name_or_path,
    #     cache_dir=model_args.cache_dir,
    ...
    # tensors = {}
    # with safe_open("/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/temporal_nobel_prize/temporal/thenlper/gte-base/matryoshka_64-128-256-512-768_filtered_avg/adapter_model.safetensors", framework="pt", device=0) as f:
    #     for k in f.keys():
