...
MODEL_NAME=jina-embeddings-v3 # jina-embeddings-v2-base-en
BACKBONE=jina-embeddings-v3 # jina-embeddings-v2-base-en
EXP_NAME=jina-embeddings-v3 # jina-embeddings-v2-base-en
OUTPUT_DIR=$OUTPUT_DIR_ROOT/$DATA_NAME/$MODEL_NAME/$BACKBONE/$EXP_NAME
CHECKPOINT_DIR=jinaai/jina-embeddings-v3 # jinaai/jina-embeddings-v2-base-en
