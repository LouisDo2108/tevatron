...
#SBATCH --qos=fitq
#SBATCH --job-name=SupervisedMAdaptor_384_512_768_chunked_v2
...
EXP_NAME=SupervisedMAdaptor_384_512_768_v2
OUTPUT_DIR=$OUTPUT_DIR_ROOT/$DATA_NAME/$MODEL_NAME/$BACKBONE/$EXP_NAME

CHECKPOINT_DIR=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/temporal_nobel_prize/madaptor/tscontriever/UnsupervisedMAdaptor_384_512_768
...
# ==== TRAIN RETRIEVER ====
python /home/thuy0050/code/tevatron/louis/madaptor/train_sup.py \
  --do_train \
  --pooling avg \
  --fp16 \
  --train_group_size 2 \
  ...
  --corpus_name $DATA_ROOT_DIR/tevatron/Tevatron___wikipedia-nq-corpus \
  --corpus_path $DATA_ROOT_DIR/temporal/temporal_nobel_prize/train/chunked/corpus.jsonl \
...
# ==== ENCODE CORPUS ====
python /home/thuy0050/code/tevatron/louis/madaptor/encode.py \
