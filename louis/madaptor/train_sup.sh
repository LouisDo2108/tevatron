...
EXP_NAME=NaiveSupervised_ontop_unsupervised_$DATA_NAME
OUTPUT_DIR=$OUTPUT_DIR_ROOT/$DATA_NAME/$MODEL_NAME/$BACKBONE/$EXP_NAME

CHECKPOINT_DIR=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/UnsupervisedMAdaptorDenseModel_temporal_nobel_prize
...
python /home/thuy0050/code/tevatron/louis/madaptor/train_sup.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/nobel_prize/train/train.jsonl \
...
python /home/thuy0050/code/tevatron/louis/madaptor/encode.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/nobel_prize/test/corpus.jsonl \
