...
corpus_records = read_json(
    "/home/thuy0050/mg61_scratch2/thuy0050/data/third_work/temporal/nanobeir_nq/corpus.jsonl",
    jsonl=True,
)
# corpus_records = [{"id": x["id"], "title": "", "text": x["text"]} for x in corpus]
corpus_lst = [x["text"] for x in corpus_records]
...
index_dir = "/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/nanobeir/nq/bm25"
...
queries_lst = [x["text"] for x in queries]
...
results, scores = retriever.retrieve(queries_tokenized, k=100, corpus=corpus_records)
