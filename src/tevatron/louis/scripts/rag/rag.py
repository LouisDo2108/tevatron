...
def main():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="mrl, madaptor, zero-shot, ts-retriever, tmrl, etc.",
    )
    parser.add_argument(
        "--flashrag_config",
        required=True,
    ...
    if MODEL_NAME == "zero-shot":
        ...
        if args.matryoshka_dim == -1:
            args.matryoshka_dim = cfg['matryoshka_dim']
    ...
    # ==== COMMANDS ====
    index_cmd = f"""
    python /home/thuy0050/code/TMRL/src/tevatron/louis/scripts/rag/index_builder.py \
    ...
    rag_cmd = f"""
    python /home/thuy0050/code/TMRL/src/tevatron/louis/scripts/rag/simple_rag.py \
