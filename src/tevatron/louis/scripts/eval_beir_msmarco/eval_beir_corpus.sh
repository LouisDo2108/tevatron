...
#SBATCH --output=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/logs/eval_beir_scifact/slurm-%x-%j.out
#SBATCH --error=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/logs/eval_beir_scifact/slurm-%x-%j.err
...
python louis/scripts/eval_beir_msmarco/eval_beir_corpus.py \
  --model $MODEL \
