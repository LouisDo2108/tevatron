...
# ==== TRAIN RETRIEVER ====
python /home/thuy0050/code/tevatron/src/tevatron/louis/src/train_tempretriever.py \
  --do_train \
  --pooling mean \
  --bf16 \
  --train_group_size 5 \
  ...
  --dataset_path /home/thuy0050/mg61_scratch2/thuy0050/data/third_work/temporal/time_sensitive_qa/development/train.jsonl \
...
python /home/thuy0050/code/tevatron/src/tevatron/retriever/driver/encode_tempretriever.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/$DATA_NAME/test/corpus.parquet \
...
python /home/thuy0050/code/tevatron/src/tevatron/retriever/driver/encode_tempretriever.py \
  ...
  --dataset_path $DATA_ROOT_DIR/temporal/$DATA_NAME/test/query.parquet \
  --model_name_or_path $OUTPUT_DIR \
  --lora_name_or_path $OUTPUT_DIR \
...
bash /home/thuy0050/code/tevatron/src/tevatron/louis/scripts/rag/simple_rag.sh "$MODEL" "$DATA_NAME" "$MODEL_NAME" "$EXP_NAME" "$LORA" "$MATRYOSHKA_DIM" "$FLASHRAG_CONFIG"