...
#SBATCH --output=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/logs/ts-retriever/slurm-%x-%j.out
#SBATCH --error=/home/thuy0050/mg61_scratch2/thuy0050/exp/tevatron/logs/ts-retriever/slurm-%x-%j.err
...
python louis/scripts/ts-retriever/train.py \
    ...
    --exp_name baseline_lora_our_dataset_v2 \
    --batch_size 256 \
    --eval_batch_size 512 \
    --num_neg 4 \
    --eval \
